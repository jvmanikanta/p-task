...
public class Workers {
	...
	public Workers(String workersName, String workersType, LocalDate workersavailablefrom, LocalDate workersavailableto,
			Available availability, String workersImg) {
		super();
